...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    check_bullet_aliean_collision(ai_settings, screen, stats, sb, ship, aliens, bullets)
...
def check_bullet_aliean_collision(ai_settings, screen, stats, sb, ship, 
        aliens, bullets):
